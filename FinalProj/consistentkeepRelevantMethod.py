...
def visualization_from_dataset(total_nodes, num_servers, server_capacity, all_requests, threshold):
    ...
    for server in ring.servers:
        ...
        if isinstance(server, Server):
            ...
            figure=os.path.join(currDir,"ConsistentRelevantOutputs",f"CHBaseline-HHFS{server.name}_sNum{serverNum}_cap{server_capacity},thold{threshold}.png")
            #plt.savefig(figure)
            # plt.show()
    ...
    plt.legend()
    figure=os.path.join(currDir,"ConsistentRelevantOutputs",f"CHBaseline-SLOT_sNum{serverNum}_cap{server_capacity},thold{threshold}.png")
    #plt.savefig(figure)
    # plt.show()
    ...
    plt.legend()
    figure=os.path.join(currDir,"ConsistentRelevantOutputs",f"CHBaseline-SHSOI_sNum{serverNum}_cap{server_capacity},thold{threshold}.png")
    #plt.savefig(figure)
    # plt.show()
    ...
    figure=os.path.join(currDir,"ConsistentRelevantOutputs",f"SHSHOI_sNum{serverNum}_cap{server_capacity},thold{threshold}.png")
    #plt.savefig(figure)
    # plt.show()
    ...
    plt.grid(True)
    figure=os.path.join(currDir,"ConsistentRelevantOutputs",f"TVRI_sNum{serverNum}_cap{server_capacity},thold{threshold}.png")
    plt.savefig(figure)
    plt.show()
    ...
    ax.legend()
    figure=os.path.join(currDir,"ConsistentRelevantOutputs",f"CHBaseline-COHHAIHFES_sNum{serverNum}_cap{server_capacity},thold{threshold}.png")
    #plt.savefig(figure)
    # plt.show()
