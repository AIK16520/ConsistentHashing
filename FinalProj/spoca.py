...
def visualization_from_dataset(total_nodes, num_servers, server_capacity, all_requests, threshold):
    ...
    for server in ring.servers:
        ...
        if isinstance(server, Server):
            ...
            figure=os.path.join(currDir,"SpocaOutputs",f"CHBaseline-HHFS{server.name}.png")
            plt.savefig(figure)
            # plt.show()
    ...
    plt.legend()
    figure=os.path.join(currDir,"SpocaOutputs","CHBaseline-SLOT.png")
    plt.savefig(figure)
    # plt.show()
    ...
    plt.legend()
    figure=os.path.join(currDir,"SpocaOutputs","CHBaseline-SHSOI.png")
    plt.savefig(figure)
    # plt.show()
    ...
    figure=os.path.join(currDir,"SpocaOutputs","SHSHOI.png")
    plt.savefig(figure)
    # plt.show()
    ...
    plt.grid(True)
    figure=os.path.join(currDir,"SpocaOutputs","TVRI.png")
    plt.savefig(figure)
    # plt.show()
    ...
    ax.legend()
    figure=os.path.join(currDir,"SpocaOutputs","CHBaseline-COHHAIHFES.png")
    plt.savefig(figure)
    # plt.show()
