...
class ConsistentHashRing:
    ...
    def findServerKey(self, request):
        ...
        if self.servers[serverKey].alive:
            ...
            if lenRequests!=0 and random.uniform(0, 1) < math.pow(float(lenRequests-matchingRequests*matchingRequests)/serverCapacity, 1):
                self.extraRun+=1
...
def visualization_from_dataset(total_nodes, num_servers, server_capacity, all_requests, threshold):
    ...
    for server in ring.servers:
        ...
        if isinstance(server, Server):
            ...
            figure=os.path.join(currDir,"SpocaRelevantOutputs",f"CHBaseline-HHFS{server.name}_sNum{num_servers}_cap{server_capacity},thold{threshold}.png")
            plt.savefig(figure)
            # plt.show()
    ...
    plt.legend()
    figure=os.path.join(currDir,"SpocaRelevantOutputs",f"CHBaseline-SLOT_sNum{num_servers}_cap{server_capacity},thold{threshold}.png")
    plt.savefig(figure)
    # plt.show()
    ...
    plt.legend()
    figure=os.path.join(currDir,"SpocaRelevantOutputs",f"CHBaseline-SHSOI_sNum{num_servers}_cap{server_capacity},thold{threshold}.png")
    plt.savefig(figure)
    # plt.show()
    ...
    figure=os.path.join(currDir,"SpocaRelevantOutputs",f"SHSHOI_sNum{num_servers}_cap{server_capacity},thold{threshold}.png")
    plt.savefig(figure)
    # plt.show()
    ...
    plt.grid(True)
    figure=os.path.join(currDir,"SpocaRelevantOutputs",f"TVRI_sNum{num_servers}_cap{server_capacity},thold{threshold}.png")
    plt.savefig(figure)
    # plt.show()
    ...
    ax.legend()
    figure=os.path.join(currDir,"SpocaRelevantOutputs",f"CHBaseline-COHHAIHFES_sNum{num_servers}_cap{server_capacity},thold{threshold}.png")
    plt.savefig(figure)
    # plt.show()
...
print("visual 1 done")
# visualization_from_dataset(total_nodes=1000, num_servers=10, server_capacity=[100,1000], all_requests=all_requests.copy(), threshold=0.25)
# print("visual 2 done")
# visualization_from_dataset(total_nodes=1000, num_servers=10, server_capacity=[100,1000], all_requests=all_requests.copy(), threshold=0.5)
# print("visual 3 done")
# visualization_from_dataset(total_nodes=1000, num_servers=10, server_capacity=[500,5000], all_requests=all_requests.copy(), threshold=0.1)
# print("visual 4 done")
# visualization_from_dataset(total_nodes=1000, num_servers=10, server_capacity=[500,5000], all_requests=all_requests.copy(), threshold=0.25)
# print("visual 5 done")
# visualization_from_dataset(total_nodes=1000, num_servers=10, server_capacity=[500,5000], all_requests=all_requests.copy(), threshold=0.5)
# print("visual 6 done")
# serverNum=[10]
